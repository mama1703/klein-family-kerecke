    ...
    <div>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 pt-12 pb-8 text-right leading-relaxed">
        ...
        <p className="mb-4">
          ...
          הספר יצא לאור בשנת 1993, בהיותו בן 70. סבי ז"ל נפטר ב-16.02.2016,
          בהיותו בן 93 שנה.
        </p>
        <p className="mb-4">
          בספר ניתן לקרוא גם שני פרקים נוספים שהוא אסף כעדות מאחיו הגדול
          ובאחותו הצעירה, ששודרו יחד עמו ועלו ארצה.
        </p>
        <p className="mb-4">
          בחלק השני, העליתי את עדותה המצולמת של סבתי האהובה, רחל (אווי) קליין,
          שנולדה בשנת 1929 ונפטרה ב-2023, בשיבה טובה, בהיותה בת 94.
        </p>
